...
class LocalDB {
  ...
  Future<int> initializeGoals() async {
    ...
    await db.rawQuery("INSERT INTO goal (type, date, goalAmount) VALUES "
        ...
        "('pushUps', '2024-12-21T00:00:00', 70),"
        "('pushUps', '2024-12-22T00:00:00', 70),"
  ...
  Future<int> initializeSets() async {
    ...
    await db.rawQuery("INSERT INTO sets (reps, time, goalId) VALUES "
        ...
        "(10, '2024-12-22T18:10:44.924267', 4),"
        "(20, '2024-12-22T18:11:44.924267', 4),"
        "(50, '2024-12-22T18:12:44.924267', 4),"
        "(11, '2024-12-23T18:12:44.924267', 5),"
        "(22, '2024-12-23T18:13:44.924267', 5),"
    );
    return 1;
  }
}
